...
const STATS = [
  { value: '₹2.5L Cr', label: "Lost annually in India's supply chain" },
  { value: '70+', label: 'Children killed in the Gambia falsified drug case' },
  { value: '40%', label: 'Agricultural produce lost before reaching shelf' },
  { value: '0', label: "Actors held financially accountable with today's systems" },
];

const CaseStudiesView: React.FC<ViewProps> = ({ onCtaClick }) => {
  return (
    <main className="pt-32 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-8 mb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <PillBadge variant="error" icon="warning">The Human Cost</PillBadge>
            <h1 className="text-[3.5rem] leading-[1.1] font-extrabold tracking-tighter mb-6 text-on-surface">
              The Next Tragedy Won't <span className="text-error">Announce Itself.</span>
            </h1>
            ...
            <p className="text-lg text-on-surface-variant max-w-xl leading-relaxed font-medium">
              India's supply chain doesn't need another monitoring tool. It needs a system where{' '}
              <span className="text-on-surface font-bold">faking data is harder than doing the right thing.</span>
            </p>
          </div>
          <div className="relative h-[400px] rounded-3xl overflow-hidden shadow-2xl">
            <img
              className="w-full h-full object-cover"
              data-alt="Modern supply chain warehouse with monitoring screens"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuB_ZgyNi4yr7GKx7afZWrsxp7YJHOEvTapcMB-N6UAtntxleEcIX8zJ7IrsQAib-DQ13IvJ-jTKJCpd_OjraS1hJmYpUAwGzP9NroCszbC0VNObQc8JiV23CiuoO5gkcz59eKkP5I4kVqnvEFao62T38jnnno2d_0HTLP7Oao0YK024vIZ_Zz1V98y7dlsr0OLpuPe1eU-C5BH2OuFKlJr4NCCD03YoHs3G4FMpnesi86BZM0AZJrfnXvLB9r4T_iN2xwky4"
            />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5">
            <div className="lg:col-span-3 p-12 lg:p-16 flex flex-col justify-center">
              ...
              <p className="text-on-surface-variant mb-8 leading-relaxed">
                This is the GIGO problem in its most devastating form. With CryoTrack, every document at every handoff is verified independently by the receiving party — and their acceptance is legally binding on-chain.{' '}
                <span className="font-bold text-on-surface">Faking a record is no longer harmless.</span>
              </p>
            ...
            <div className="lg:col-span-2 relative min-h-[400px]">
              <img
                ...
                data-alt="Close up of pharmaceutical cold chain storage with temperature monitoring"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuCCp_wSrCSwkihnJMi66aPnapwwgqyfgy2JkEwKXmI2Z2F7fUwWf4ZuH5jXdQ7O9wfnCtYD4gFyBgWOyGZvQVct6_MzaY-P0Z1Nd7czfRNOF7agZLrjolOxKH5gddxplf-TCIGC9SA07cxMhznyR235RSkS4nmCHNv5HeNmYNP01OA6rZFECZaHEoqHzCLc7hqIPXHJix66BAEDmJ0qeBaKAuuBmOKrg4HHuSKtmsttqWx1GwpEL00"
              />
            </div>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-8 mb-24">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-7 bg-surface-container-high rounded-[2rem] p-12 flex flex-col justify-between">
            <div>
              <div className="inline-block px-4 py-1 bg-error/10 backdrop-blur-sm rounded-full text-[0.6875rem] font-bold text-error mb-6">
                RAMNAGAR 2020: A CALL FOR AUTOMATION
              </div>
              ...
              <p className="text-on-surface-variant leading-relaxed">
                CryoTrack's Game-Theoretic Checkpoints directly address this — every actor who accepts a handoff simultaneously accepts 100% financial and legal liability for the condition of that shipment.{' '}
                <span className="font-bold text-on-surface">Silence is no longer an option.</span>
              </p>
            </div>
            <div className="mt-12">
              <img
                className="w-full h-48 object-cover rounded-2xl shadow-lg mb-6"
                data-alt="Digital verification network visualization"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAHE7w36hVBpJZsPTKSYQgQ13zjWTmPosARA5btqtodUmjjsHQ9Q24WrbW9Z-S9oibZVidBGdcOEwgBd5e7YrfFD-w6WzSX0qSzdk21ay3geaJJ1seiXs95j2bazEeC1pCDop_wOROXkxlDC37dXXRhemzh3QrM3P3_DpkhJjaxaFaEkB9QCtGaM8y5__UqdzVFIHJGtg62opc1qNNSSAcZYuWrajLGWABttKPxZUGp0HHt6sGqCVrW5iRbcFXgBhVAzUSW7IsWyuw"
              />
          ...
          <div className="md:col-span-5 grid grid-rows-2 gap-8">
            <div className="bg-primary text-on-primary rounded-[2rem] p-8 relative overflow-hidden group">
              <div className="relative z-10">
                ...
                <p className="text-on-primary/80 text-sm">
                  Every handoff creates an immutable record of who accepted, what condition was verified, and what the AI flagged — permanently, on-chain.
                </p>
              </div>
              <span className="material-symbols-outlined absolute -right-4 -bottom-4 text-white/10 text-9xl rotate-12 group-hover:rotate-0 transition-transform duration-500">
                account_tree
              </span>
            </div>
            <div className="bg-white rounded-[2rem] p-8 shadow-sm flex flex-col justify-between border border-primary/5">
              ...
              <p className="text-on-surface-variant text-sm mt-4">
                Pilot participants use our Zero-Friction Mobile OCR app to cryptographically verify handoffs — eliminating data forgery at the point of transfer.
              </p>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-8">
        <CtaBanner
          heading="Your Supply Chain Shouldn't Be a Risk."
          subtext="Stop relying on hope and manual logs. Join the network of businesses that treat supply chain accountability as a legal fact, not a prayer."
          primaryLabel="Request a Demo"
          onPrimary={onCtaClick}
          secondaryLabel="Speak with an Engineer"
        />
      </section>
    </main>
  );
